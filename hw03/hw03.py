...
def digit_distance(n):
    ...
    if n<10:
        ...
        return digit_distance(n//10)+abs(ls(n)-qi(n))
...
def count_dollars(total,bill=100):
    ...
    if bill==1:
        return 1
    with_bill=count_dollars(total-bill,bill)
    without_bill=count_dollars(total,next_smaller_dollar(bill))
...
def count_dollars_upward(total,bill=100):
