...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    total=0
    if num_rolls==0:
        total=boar_brawl(player_score,opponent_score)
    else :
...
def make_averaged(original_function, times_called=1000):
    ...
    def averaged_function(*args):
        ...
        for _ in range(times_called):
            t+=original_function(*args)
        return t/times_called
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    scores=[]
    for i in range(1,11):
        m=make_averaged(roll_dice,times_called)(i,dice)
        scores.append(m)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    m=sus_update(0,score,opponent_score,dice=six_sided)-score
    if m<threshold:
        return num_rolls
    else:
        return 0
...
def hailstone(n):
    ...
    if n==1:
        ...
        return hailstone(even(n))
    else:
        return hailstone(odd(n))
